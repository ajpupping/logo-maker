...
const generateSVG = (answers) => {
    const shapes = {
        ...
        triange:`<polygon points="150,10 250,190 50,190" fill="${answers.shapeColor}" />`,
    }
    return `
    <svg width="300" height="200">
    ${shapes[answers.shape]}
    <text x="50%" y="50%" text-anchor="middle" fill="${answers.textColor}" font-size="40" dy=".3em">${answers.text}</text>
    </svg>
    `;
};
